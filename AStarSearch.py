...
rubbish_properties = {
    (0, 0): {'weight': 10, 'volume': 1},
    (1, 2): {'weight': 30, 'volume': 3},
    (2, 3): {'weight': 5, 'volume': 1},
    (3, 4): {'weight': 5, 'volume': 1},
    (3, 1): {'weight': 5, 'volume': 3},
    (4, 3): {'weight': 10, 'volume': 2},
    (4, 1): {'weight': 20, 'volume': 1},
    (6, 4): {'weight': 10, 'volume': 2},
    (6, 1): {'weight': 5, 'volume': 2},
    (7, 5): {'weight': 30, 'volume': 1},
    (7, 2): {'weight': 20, 'volume': 2},
    (8, 4): {'weight': 10, 'volume': 3}
}
...
# If rubbish bin is not 40 and 5
